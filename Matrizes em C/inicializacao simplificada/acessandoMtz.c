...
//No código apresentado, o programa em C define uma matriz 3x3 chamada matriz e preenche essa matriz com valores inteiros. A matriz é inicializada com os seguintes valores:
